...
coords_lbl.set_text("Toca la pantalla")
coords_lbl.set_style_text_color(lv.color_hex(0xFFFFFF), 0)
coords_lbl.center()

def screen_clicked(e):
    p = lv.point_t()
    indev.get_point(p)
    coords_lbl.set_text("x={} y={}".format(p.x, p.y))

scrn.add_event_cb(screen_clicked, lv.EVENT.CLICKED, None)
